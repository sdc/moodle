...
class PluginFamilyQualification extends Qualification{
	...
	//any properties
    public function PluginFamilyQualification($qualID, $params, $loadParams)
    {
        return parent::Qualification($qualID, $params, $loadParams);
    }
    /**
    ...
    {
        return new PluginFamilyQualification($qualID, $params, $loadParams);
    }
            ...
            $familyID = -1, $params = null, $loadParams = null)
    {
        ...
        return new PluginQualification();
    }
}
