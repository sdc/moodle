...
class BTECHigherCriteria extends BTECCriteria{
    
    public function BTECHigherCriteria($criteriaID, $params, 
    ...
    public static function get_instance($criteriaID, $params, 
            $loadLevel = Qualification::LOADLEVELCRITERIA)
   {
        return new BTECHigherCriteria($criteriaID, $params, $loadLevel);
    }
    //put your code here
}
