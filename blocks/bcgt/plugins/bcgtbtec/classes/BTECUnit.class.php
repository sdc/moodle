...
//            $studentsSessionArray[$student->id] = $student;
            ...
            $output .= "<td class='unitCommentTD {$class}'>";            
                ...
                $output .= "<div class='hiddenCriteriaCommentButton'>";
                    ...
                    $output .= "<div class='popUpDiv bcgt_unit_comments_dialog' id='dialog_S{$student->id}_U{$this->id}_Q{$qualID}' qualID='{$qualID}' unitID='{$this->id}' critID='-1' studentID='{$student->id}' grid='student' imgID='{$cellID}' title='Comments'>";
            ...
            // End Unit Comment  
            $output .= $this->build_unit_grid_students_details($student, $qualID, $context);
