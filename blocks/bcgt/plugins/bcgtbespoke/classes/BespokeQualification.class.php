    ...
    public function export_specification(){
        ...
        if ($units)
        {
            ...
            foreach($units as $unit)
            {
                ...
                // Unit grading
                $objPHPExcel->getActiveSheet()->setCellValue("A9", "Unit Grading Structure (Serialized Object)");
                $objPHPExcel->getActiveSheet()->setCellValue("B9", $unit->get_grading_info());
                ...
                $objPHPExcel->getActiveSheet()->setCellValue("D10", "Criteria Grading Structure (Serialized Object)");
                ...
                if ($criteria)
                {
                    foreach($criteria as $criterion)
                    {
                        ...
                        $objPHPExcel->getActiveSheet()->setCellValue("D{$rowNum}", $criterion->get_grading_serialized_object());
