...
JS;
    ...
    public static function display_create_form(){
        ...
        $output .= "<div style='float:left;width:30%;'>";
        
        $output .= "<b>Starting Point</b><br>";
        ...
        $output .= "<p class='c'><input type='text' placeholder='Report Name' name='report_name' value='".( ( $report ) ? $report->name : '' )."' /> <input type='submit' name='save_report' value='Save' /></p>";
...
JS;
    ...
    public static function display_view_reports(){
        ...
        $output .= "<table>";
            ...
            $output .= "<tr><th>Report Name</th><th>Created By</th><th>No. Runs</th><th>Last Run</th><th></th></tr>";
