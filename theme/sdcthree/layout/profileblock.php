...
<div class="profilebar" id="profilebar" style="display: none;">
    ...
    <div class="profilebar_account">
        ...
        <div class="profileoptions" id="profileoptions">
            ...
            <li><a href="https://leap.southdevon.ac.uk/"><img src="<?php echo $OUTPUT->pix_url('profile/profile', 'theme')?>" />&nbsp;<?php echo get_string('myprofile');?></a></li>
            ...
            <!-- li><a href="<?php // echo $PAGE->theme->settings->emailurl;?> "><img src="<?php //echo $OUTPUT->pix_url('profile/email', 'theme')?>" />&nbsp;<?php //echo get_string('email','theme_sdcthree');?></a></li -->
