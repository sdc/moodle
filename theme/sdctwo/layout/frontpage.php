...
<div id="page">
    ...
    <div id="page-header" class="clearfix">
        <div id="header-envelope">
<?php
$pics = array('a', 'g', 'i', 'k', 'n', 'o', 'p', 'r', 's', 't', 'u', 'w', 'y');
$final_str = 'logo-mdl-'.$pics[rand(0, count($pics)-1)];
?>
            <h1 class="headermain">
                <?php //echo $PAGE->heading ?>
            </h1>
            <div id="logo">
                <img class="sitelogo" src="<?php echo $OUTPUT->pix_url($final_str, 'theme'); ?>" alt="SDC Moodle logo [<?php echo $OUTPUT->pix_url($final_str, 'theme'); ?>]" />
            </div>
