...
/**
 * The main activitytypeheader configuration form
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_activitytypeheader_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement(
			...
			get_string('activitytypeheadername', 'activitytypeheader'), 	//label
		...
		*/
		 ...
		 */
		//$mform->addHelpButton('name', 'activitytypeheadername', 'activitytypeheader');
